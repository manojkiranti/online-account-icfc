      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box">
          <a href="/" class="logo logo-dark">
            <span class="logo-sm">
              <img src="@/assets/images/nfl-logo.png" class="img-fluid" alt height="22" />
            </span>
            <span class="logo-lg">
              <img src="@/assets/images/nfl-logo.png" class="img-fluid" alt height="20" />
            </span>
          </a>
          ...
          <a href="/" class="logo logo-light">
            ...
            <span class="logo-lg">
              <img src="@/assets/images/nfl-logo.png" alt height="50" />
            </span>
          </a>
        </div>
