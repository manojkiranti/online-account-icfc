<template>
  <Layout :class="editable ? 'editable-form': 'non-editable'">
    ...
    <div class="row mb-4" v-if="(isDataLoaded && userDetail.accountStatus.account_status == 'Submitted') || (isDataLoaded &&userDetail.accountStatus.account_status == 'Approved' ) || (isDataLoaded &&userDetail.accountStatus.account_status == 'Repaired' )">
    <!-- <div class="row mb-4"> -->
      <div class="col-md-12 d-flex justify-content-end">
        <div class="button-items">
