...
export default {
  authReference (payload) {
    return new Promise((resolve, reject) => {
      Repository.post(`track-account/otp`, payload)
        .then((response) => {
  ...
  otpReferenceVerify (token,phone,payload) {
    return new Promise((resolve, reject) => {
      Repository.post(`track-account/otp-verify/${token}/${phone}`, payload)
        .then((response) => {
          resolve(response.data);
        })
        .catch((error) => {
  ...
  verifyOtpApi(token, payload) {
    return new Promise((resolve, reject) => {
      Repository.post(`${resource}/email-otp-verification/${token}`, payload)
        .then((response) => {
          resolve(response.data);
        })
        .catch((error) => {
  ...
  saveDraft(ref) {
    return new Promise((resolve, reject) => {
      Repository.get(`${resource}/save-as-draft/${ref}`,)
        .then((response) => {
          resolve(response.data);
        })
        .catch((error) => {
  ...
  stepThreeUpdate(data, guid) {
    return new Promise((resolve, reject) => {
      Repository.post(`${resource}/third-step-update/${guid}`, data)
        .then((response) => {
          resolve(response.data);
        })
        .catch((error) => {
